"""
Module defines position web application view.
"""
...
def get_positions():
    """
    Returns rendered template to show all positions.
    """
...
def get_position(position_id):
    """
    Returns rendered template to show position with its employees.
    """
...
def add_position():
    """
    Returns rendered template to add position.
    """
    form = PositionForm()
    if form.validate_on_submit():
        if not PositionService.get_pos_by_name(form.name.data):
            ...
            flash('Position {} already exists. Enter another name.'.format(
                form.name.data))
...
def delete_position(position_id):
    """
    Returns rendered template to delete position.
    """
...
def edit_position(position_id):
    """
    Returns rendered template to edit position.
    """
    position = PositionService.get_pos_by_id(position_id)
